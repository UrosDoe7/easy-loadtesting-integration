...
4) download the lab  
       ...
       cd;
       git clone https://github.com/dynatracelab/load-testing-automation

5) copy the tests plan  

       cd;
       cp load-testing-automation/test-plan-* docker-jmeter/tests/
...
7) test-plan-without-integration : find the jmx [here](https://github.com/dynatracelab/load-testing-automation/blob/main/test-plan-without-integration.jmx)   
...
| cd;git clone https://github.com/dynatracelab/load-testing-automation | ls load-testing-automation | ✔️ |
| cd;mv load-testing-automation/test-plan-with* docker-jmeter/tests/ | ls docker-jmeter/tests | ✔️ |
...
| cd;cd /docker-jmeter;./run.sh -n -t tests/load-testing-automation/test-plan-without-integration.jmx -Jhostname=$Hostname -l tests/loadtcd esting-lab/LoadTest.jlt & | tail -f ests/loadtcd esting-lab/LoadTest.jlt | ✔️ |
